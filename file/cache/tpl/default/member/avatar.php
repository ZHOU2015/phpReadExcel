...
<style type="text/css">
.avatar_upload {overflow:hidden;position:relative;width:128px;height:128px;background:url('<?php echo DT_STATIC;?><?php echo $MODULE['2']['moduledir'];?>/image/avatar_upload.gif') no-repeat center center;border:#DDDDDD 1px solid;}
.avatar_uploading {overflow:hidden;position:relative;width:128px;height:128px;background:url('<?php echo DT_STATIC;?><?php echo $MODULE['2']['moduledir'];?>/image/avatar_uploading.gif') no-repeat center center;border:#DDDDDD 1px solid;}
...
<td class="tab"><a href="edit.php"><span>基本信息</span></a></td>
</tr>
</table>
</div>
<table cellpadding="0" cellspacing="0">
...
<?php if($avatar) { ?><br/><br/><a href="?action=delete" class="t" onclick="return confirm('确定要删除您的个人头像吗？');">[删除头像]</a><?php } ?>
</td>
...
<input type="file" name="upfile" id="upfile" class="avatar_file" onchange="if(isImg('upfile', 'jpg|jpeg|gif|png')){Dh('avatar_upload');Ds('avatar_uploading');this.form.submit();}" /></div>
</form>
</div>
</td>
</tr>
