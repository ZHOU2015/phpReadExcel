<?php defined('IN_DESTOON') or exit('Access Denied');?><input name="captcha" id="captcha" type="text" onfocus="showcaptcha();" value="点击显示" placeholder="验证码" class="txt imgCode"/>
<div class="img_btn">
<img src="<?php echo DT_SKIN;?>image/loading.gif" title="验证码,看不清楚?请点击刷新&#10;字母不区分大小写" alt="" align="absmiddle" id="captchapng" onclick="reloadcaptcha();" style="display:none;cursor:pointer;"/><span id="ccaptcha"></span>
</div>
